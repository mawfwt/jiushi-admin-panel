...
| 模组 | JAR 文件 | 版本 | 大小 | 类型 |
| --- | --- | --- | --- | --- |
| 核心面板 | `_jiushi_admin-1.20.1-1.0.8-alpha.jar` | 1.0.8-alpha | ~97 KB | 必装 |
...
| --- | --- | --- | --- | --- |
| Core Panel | `_jiushi_admin-1.20.1-1.0.8-alpha.jar` | 1.0.8-alpha | ~97 KB | Required |
